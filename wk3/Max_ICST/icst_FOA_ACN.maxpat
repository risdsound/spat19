...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1440.7567138671875, 51.282054901123047, 29.5, 22.0 ],
					"text" : "1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 1440.7567138671875, 17.948734283447266, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1435.059814453125, 104.794830322265625, 43.0, 21.0 ],
					"triscale" : 0.9,
					"varname" : "position[3]"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1479.059814453125, 104.794830322265625, 43.0, 21.0 ],
					"triscale" : 0.9,
					"varname" : "position[4]"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1523.059814453125, 104.794830322265625, 43.0, 21.0 ],
					"triscale" : 0.9,
					"varname" : "position[5]"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1279.0341796875, 104.794830322265625, 43.0, 21.0 ],
					"triscale" : 0.9,
					"varname" : "position[6]"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1323.0341796875, 104.794830322265625, 43.0, 21.0 ],
					"triscale" : 0.9,
					"varname" : "position[7]"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1367.0341796875, 104.794830322265625, 43.0, 21.0 ],
					"triscale" : 0.9,
					"varname" : "position[8]"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 118.085678100585938, 446.153839111328125, 84.0, 22.0 ],
					"text" : "mc.unpack~ 4"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 864.96728515625, 677.77777099609375, 71.0, 22.0 ],
					"text" : "send~ acn3"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 791.96728515625, 677.77777099609375, 71.0, 22.0 ],
					"text" : "send~ acn3"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 718.96728515625, 677.77777099609375, 71.0, 22.0 ],
					"text" : "send~ acn2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 647.17236328125, 677.77777099609375, 71.0, 22.0 ],
					"text" : "send~ acn1"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 232.0, 317.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 232.0, 66.0, 30.0, 30.0 ]
								}
...
,
					"patching_rect" : [ 647.17236328125, 624.78631591796875, 236.1923828125, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "signal", "signal", "signal", "signal" ],
					"patching_rect" : [ 710.94586181640625, 446.153839111328125, 84.0, 22.0 ],
					"text" : "mc.unpack~ 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "signal", "signal", "signal", "signal" ],
					"patching_rect" : [ 358.1080322265625, 446.153839111328125, 84.0, 22.0 ],
					"text" : "mc.unpack~ 4"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 461.445770263671875, 677.77777099609375, 109.0, 20.0 ],
					"text" : "AMBIX ACN SN3D"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "signal", "signal", "signal", "signal" ],
					"patching_rect" : [ 1055.0057373046875, 531.03411865234375, 97.0, 21.0 ],
					"saved_object_attributes" : 					{
						"active" : [ 1, 1 ],
						"aed_scale" : 10.0,
						"center_att_db" : 6.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "signal", "signal", "signal", "signal" ],
					"patching_rect" : [ 61.957256317138672, 60.346153259277344, 102.0, 22.0 ],
					"text" : "adc~ 41 42 43 44"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 302.0, 737.8717041015625, 38.571430206298828, 22.0 ],
					"text" : "dac~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 250.83782958984375, 629.6068115234375, 31.0, 22.0 ],
					"text" : "plug"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 302.0, 677.77777099609375, 156.0, 22.0 ],
...
,
					"snapshot" : 					{
						...
						"snapshot" : 						{
							...
							"isbank" : 0,
							"isbase64" : 1,
							"blob" : "188.CMlaKA....fQPMDZ....ADjPoEC....Y...............................................fVMjLgbG....OMkETLU0QI4zTEQEUI4zQSARXiQWZ1UFTxU1bkQWOhHBHvIWYyUFcDklb8HxKUMWYxM2KyMyYuvTZhIWXxk2Kg0lXog2KhklagUmbgw1WvIWYyUFcyIBHC8la1ITclYVYxMUZ5UVOh.iHfbTXo4VOh.iK0HxK9.."
						}
,
						"snapshotlist" : 						{
							"current_snapshot" : 0,
