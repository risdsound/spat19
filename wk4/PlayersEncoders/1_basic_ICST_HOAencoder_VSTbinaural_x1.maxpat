...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 253.029388427734375, 408.971923828125, 29.5, 22.0 ],
					"text" : "2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 253.029388427734375, 381.62152099609375, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 253.029388427734375, 474.783935546875, 48.0, 22.0 ],
					"text" : "type $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 253.029388427734375, 440.5543212890625, 112.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 109.577323913574219, 662.857177734375, 489.5, 22.0 ],
...
, 			{
				"box" : 				{
					"color" : [ 0.996078431372549, 0.015686274509804, 0.015686274509804, 1.0 ],
					"fontsize" : 18.0,
					"id" : "obj-119",
					"maxclass" : "newobj",
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1186.345947265625, 689.857177734375, 78.0, 22.0 ],
					"text" : "send~ acn15"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1104.528564453125, 689.857177734375, 78.0, 22.0 ],
					"text" : "send~ acn14"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1022.711181640625, 689.857177734375, 78.0, 22.0 ],
					"text" : "send~ acn13"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 940.89385986328125, 689.857177734375, 78.0, 22.0 ],
					"text" : "send~ acn12"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 859.00482177734375, 689.857177734375, 77.0, 22.0 ],
					"text" : "send~ acn11"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 777.25909423828125, 689.857177734375, 78.0, 22.0 ],
					"text" : "send~ acn10"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 695.44171142578125, 689.857177734375, 71.0, 22.0 ],
					"text" : "send~ acn9"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 613.62445068359375, 689.857177734375, 71.0, 22.0 ],
					"text" : "send~ acn8"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1186.86474609375, 662.857177734375, 71.0, 22.0 ],
					"text" : "send~ acn7"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1105.04736328125, 662.857177734375, 71.0, 22.0 ],
					"text" : "send~ acn6"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1023.22998046875, 662.857177734375, 71.0, 22.0 ],
					"text" : "send~ acn5"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 941.41265869140625, 662.857177734375, 71.0, 22.0 ],
					"text" : "send~ acn4"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 859.5953369140625, 662.857177734375, 71.0, 22.0 ],
					"text" : "send~ acn3"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 777.7779541015625, 662.857177734375, 71.0, 22.0 ],
					"text" : "send~ acn2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 695.9605712890625, 662.857177734375, 71.0, 22.0 ],
					"text" : "send~ acn1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 613.62445068359375, 662.857177734375, 71.0, 22.0 ],
					"text" : "send~ acn0"
				}
...
, 			{
				"box" : 				{
					...
					"saved_object_attributes" : 					{
						...
						"formantcorrection" : 0,
						"mode" : "basic",
						"originallength" : [ 195049.295238095190143, "ticks" ],
