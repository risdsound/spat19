...
,
						"classnamespace" : "box",
						"rect" : [ 1776.0, 215.0, 1005.0, 474.0 ],
						"bglocked" : 0,
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 441.0, 153.0, 440.0, 20.0 ],
									"text" : "This subpatch does nothing, except pass the data in and then out."
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 391.0, 344.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 391.0, 89.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 136.0, 89.0, 30.0, 30.0 ]
								}
...
,
					"patching_rect" : [ 150.0, 184.0, 163.0, 22.0 ],
...
,
					"text" : "p this-can-be-called-anything"
				}
